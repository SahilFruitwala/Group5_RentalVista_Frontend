              ...
              <Col sm={4}>
                <ListGroup>
                  <ListGroup.Item style={{ border: "none" }}>
                    <FontAwesomeIcon icon={faDollarSign} color="#F7A231" /> {rent} / Month
                  </ListGroup.Item>
                  <ListGroup.Item style={{ border: "none" }}>
                    <FontAwesomeIcon icon={faCalendarCheck} color="#F7A231" /> Available From: {date}
                  </ListGroup.Item>
                  <ListGroup.Item style={{ border: "none" }}>
                    <FontAwesomeIcon icon={faBed} color="#F7A231" /> {bedroom} Bedrooms
                  </ListGroup.Item>
                  <ListGroup.Item style={{ border: "none" }}>
                    <FontAwesomeIcon icon={faBath} color="#F7A231" /> {bathroom} Bath
                  </ListGroup.Item>
                  {/* <ListGroup.Item style={{ border: "none" }}>
