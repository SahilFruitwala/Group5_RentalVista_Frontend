                        ...
                        <div class="card1--content">
                          ...
                          >
                            ...
                            <Card.Body>
                              ...
                              <Link
                                to={`/view-room/${room.rent},${room.date},${room.bedrooms},${room.bathrooms},${room.description},${room.roomID}`}
                              >
                                <Button
                                  variant="warning"
                    ...
                    {!room.disabled ? (
                      ...
                      >
                        ...
                        <Card.Body>
                          ...
                          <Link
                            to={`/view-room/${room.rent},${room.date},${room.bedrooms},${room.bathrooms},${room.description}`}
                          >
                            <Button
                              variant="warning"
                              style={{ marginLeft: "15px" }}
